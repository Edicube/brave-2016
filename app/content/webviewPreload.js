...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // This preload runs in an isolated world now, so confirm it can still reach
  // the page's DOM, which is what everything above depends on.
  if (typeof process !== 'undefined' && process.env && process.env.BRAVE_DEBUG) {
    console.log(`webviewPreload active: ${document.querySelectorAll('*').length} nodes reachable, ` +
